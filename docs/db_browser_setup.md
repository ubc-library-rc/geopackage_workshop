...
Unfortunately, setting up the software is not quite as straightforward as installing one piece of software. But if you've ever installed a mod for a video game, it's a somewhat similar procedure.
...
Once everything is installed, you can move on to [using a GeoPackage](premade_geopackages.html).
